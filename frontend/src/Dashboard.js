        ...
        <div className="status-tabs">
          ...
          <div className="tab-left">
            {[
              ...
              <button
                key={tab.name}
                className={`tab-btn ${currentTab.toLowerCase() ===
          ...
          <div className="modal-content">
            ...
            <form onSubmit={handleSaveJob}>
              ...
              <div className="modal-actions">
                <button type="button" className="btn-cancel" disabled={isCreatingJob} onClick={() => setIsModalOpen(false)}>
                  Hủy bỏ
                </button>
                <button
                  type="submit"
